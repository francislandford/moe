...
class _AddSchoolPageState extends State<AddSchoolPage> {
  ...
  final _emisCodeController = TextEditingController(); // NEW: EMIS Code
  ...
  void dispose() {
    ...
    _emisCodeController.dispose(); // NEW
  ...
  // In AddSchoolPage.dart, update the _generateSchoolCode method:
  ...
  Future<void> _submitForm() async {
    ...
    final schoolData = {
      ...
      // Only include these fields if consent is Yes
      if (_hasConsent) ...{
        'emis_code': _emisCodeController.text.trim(), // NEW: EMIS Code
        'tvet': _isTvet ? '1' : '0',
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // 2. School Identity - with school level, type, ownership and compliance
                        _buildSectionCard(
                          ...
                          children: [
                            ...
                            // Auto-generated School Code (read-only)
                            // TextFormField(
                            //   initialValue: _autoGeneratedSchoolCode,
                            //   decoration: InputDecoration(
                            //     labelText: 'School Code: ${_autoGeneratedSchoolCode.isNotEmpty ? _autoGeneratedSchoolCode : 'Generating...'}',
                            //     border: const OutlineInputBorder(),
                            //     filled: true,
                            //     fillColor: Colors.grey.shade100,
                        ...
                        // Hidden Sections - only shown if compliance is Yes
                        if (_hasConsent) ...[
                          // 3. Classification
                          _buildSectionCard(
                            title: 'Classification',
                            children: [
                              // NEW: EMIS Code (optional)
                              CustomTextField(
