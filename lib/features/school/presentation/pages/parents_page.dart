...
class _ParentPageState extends State<ParentPage> {
  ...
  Future<void> _refreshQuestionsIfOnline() async {
    ...
    try {
      print('Refreshing parent participation questions from API...');
      final qRes = await http.get(
        Uri.parse('${AppUrl.url}/questions?cat=Parents'),
        headers: headers,
      );
      ...
      if (qRes.statusCode == 200) {
        ...
        if (mounted) {
          ...
          // Cache fresh data
          await LocalStorageService.saveToCache('parent_questions', list);
        }
      }
    } catch (e) {
      print('Background refresh parent questions failed: $e');
    }
  }
  ...
  Future<void> _submit() async {
    ...
    print('Parent Participation payload:');
    ...
    try {
      ...
      if (isOnline) {
        ...
        if (res.statusCode == 200 || res.statusCode == 201) {
          message = 'Parent participation assessment saved successfully!';
          color = Colors.green;
        ...
        await ParentLocalStorageService.savePending(payload);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(
        title: 'Module: Parent Participation at ${_schoolName ?? ''}',
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Offline Parent Participation',
            onPressed: () => context.push('/offline-parent-participation'),
          ),
        ],
      ),
                                ...
                                children: [
                                  ...
                                  Text(
                                    'The purpose of this module is to verify information the Principal has told you and to make sure parents and students are involved in improving their school.\n\n'
                                        'Parents\n'
                                        'Meet with at least two males and two female parents selected by you without the presence of the Principal, PTA chairperson or teachers.',
                                    style: TextStyle(
                                      fontSize: 16,
                                      height: 1.5,
                            ...
                            child: StreamBuilder<bool>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ElevatedButton.icon(
                                  ...
                                  label: const Text('Submit Parent Participation', style: TextStyle(fontSize: 17)),
